        ...
        <>
            ...
            <Modal isOpen={isOpen} onClose={onClose} >
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <Box p={'10px'}>
                            <Box p={'5px'} bg={'#808080'} textAlign={'center'} borderRadius={'30px'} mb={'20px'} >
